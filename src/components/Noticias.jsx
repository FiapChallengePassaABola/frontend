      ...
      <div className="flex flex-col lg:flex-row w-full max-w-7xl gap-6 lg:gap-10">
        <div className="w-full lg:w-2/3">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-[#B0AFAF] mt-2">
            Voltamos pra contar como tem sido nossos dias desde a chegada da
            Antonella. Foram muitos aprendizados e momentos especiais, e claro
            que viemos dividir aqui com vocês. Mais uma montanha russa de
            emoções. Vem conversar e debater com a gente
          </p>
        </div>
