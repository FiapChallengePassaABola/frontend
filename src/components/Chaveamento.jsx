        ...
        <div className="w-full">
          <div className="block lg:hidden">
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h3 className="text-white text-base sm:text-lg font-bold text-center mb-3 sm:mb-4 bg-gradient-to-r from-[#592B78] to-[#8B3A4A] px-3 sm:px-4 py-1 sm:py-2 rounded-full">
                  OITAVAS DE FINAL
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="space-y-1">
                    <h4 className="text-white text-xs font-semibold text-center mb-1 bg-[#592B78] px-2 py-1 rounded-full">
                      Chave A
                    </h4>
              ...
              <div>
                <h3 className="text-white text-base sm:text-lg font-bold text-center mb-3 sm:mb-4 bg-gradient-to-r from-purple-300 to-purple-400 px-3 sm:px-4 py-1 sm:py-2 rounded-full">
                  FINAL
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div className="space-y-1">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-white text-xs font-semibold text-center mb-1 bg-gradient-to-r from-purple-300 to-purple-400 px-2 py-1 rounded-full">
                      CAMPEÃO
                    </h4>
                    <TimesChaveamento
                      team={mockTeams[0]}
          ...
          <div className="hidden lg:flex lg:flex-nowrap justify-center gap-2 xl:gap-4 items-center">
            <div className="flex flex-col space-y-2 xl:space-y-1 min-w-[120px] xl:min-w-[130px]">
              <h3 className="text-white text-xs font-semibold text-center mb-1 bg-[#592B78] px-2 py-1 rounded-full">
                Oitavas
              </h3>
