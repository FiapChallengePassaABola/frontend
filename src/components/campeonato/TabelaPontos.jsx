          ...
          <table className="min-w-full">
            ...
            <tbody>
              {sorted.map((t, idx) => (
                <tr
                  key={t.id}
                  className={`relative text-white text-xs sm:text-sm lg:text-base`}
                >
                  <td className="px-3 py-3 align-middle">
                    <div
                      className={`w-8 h-8 grid place-items-center rounded-full text-xs sm:text-sm font-extrabold border ${
                        idx === 0
                  ...
                  <td className="px-3 py-3 text-center align-middle font-semibold">
                    {t.gd}
                  </td>
                  ...
                  <td className="px-3 py-3 text-center align-middle">
                    <div className="flex items-center justify-center gap-1">
                      {t.form.split("").map((c, i) => (
                        <span
                          key={i}
                          className={`h-2.5 w-2.5 rounded-full ${formDot(c)}`}
                        ></span>
                      ))}
                    </div>
                  </td>
