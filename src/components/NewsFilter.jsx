...
function NewsFilter({ categories, activeFilter, onFilterChange, onSearchChange, onTimeFilterChange }) {
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center">
                <div className="flex-1 relative">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#1B4509] focus:border-transparent"
                    />
                </div>
