...
export const jogadoraServiceRealtime = {
  ...
  async createJogadora(jogadoraData) {
    try {
      console.log(
        "Iniciando criação da jogadora no Realtime Database:",
        jogadoraData
      );
      ...
      console.log(
        "Jogadora criada com sucesso no Realtime Database, ID:",
        jogadoraId
      );
      ...
      console.error(
        "Erro detalhado ao criar jogadora no Realtime Database:",
        error
      );
  ...
  async getJogadorasPorExperiencia(experiencia) {
    try {
      ...
      const jogadorasRef = ref(realtimeDb, COLLECTION_NAME);
      const experienciaQuery = query(
        jogadorasRef,
        orderByChild("experiencia"),
        equalTo(experiencia)
      );
  ...
  async atualizarStatusJogadora(id, status) {
    try {
      ...
      const updatedAtRef = ref(
        realtimeDb,
        `${COLLECTION_NAME}/${id}/updatedAt`
      );
