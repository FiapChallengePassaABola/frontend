...
function PageNoticias(){
    ...
    const noticias = [
        {
            img: VideoYT,
            titulo: "Gol de Haaland garante vitória apertada do City sobre o Brentford",
            descricao: "O Manchester City superou o Brentford com uma vitória por 1-0 no Gtech Community Stadium, graças ao gol cedo de Erling Haaland. O atacante norueguês finalizou com precisão aos nove minutos.",
            fonte: "PassaBola",
        ...
        {
            img: VideoYT,
            titulo: "Será o protagonista da Seleção? Vini Jr ressurge no Real e vira capa",
            descricao: "Vini Jr tem protagonizado uma REDENÇÃO no Real Madrid. Após uma reta final discreta em 2024/25, ele parece ter retomado o alto nível. Já são NOVE participações diretas em gol em apenas.",
            fonte: "PassaBola",
        ...
        {
            img: VideoYT,
            titulo: "Arrascaeta e Varela não serão convocados pelo Uruguai; veja as situações",
            fonte: "MundoBola",
        ...
        {
            img: VideoYT,
            titulo: "Agenda de DOMINGO: BR25 pega fogo, BuLi no OF, dérbis na Europa e +",
            fonte: "PassaBola",
    ...
    const categories = ["Internacional", "Mercado", "Seleções", "Agenda", "Brasileirão"];
    ...
    const verificarTempoFiltro = (tempoAtras, filtro) => {
        ...
        if (filtro === 'ontem' && tempoAtras.includes('horas') && parseInt(tempoAtras) > 12) return true;
    ...
    const filteredNoticias = noticias.filter(noticia => {
        const categoriaMatch = activeFilter === 'todas' || noticia.categoria === activeFilter;
        const buscaMatch = searchTerm === '' || 
            noticia.titulo.toLowerCase().includes(searchTerm.toLowerCase()) ||
            (noticia.descricao && noticia.descricao.toLowerCase().includes(searchTerm.toLowerCase()));
        const tempoMatch = timeFilter === 'todas' || verificarTempoFiltro(noticia.tempoAtras, timeFilter);
